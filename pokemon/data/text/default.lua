...
____exports.DefaultText = {
    ...
    unboost = {fail = "  [POKEMON]'s stats were not lowered!", failSingular = "  [POKEMON]'s [STAT] was not lowered!"},
    ...
    mudsport = {start = "  Electricity's power was weakened!", ["end"] = "  The effects of Mud Sport have faded."},
    trickroom = {
        start = "  [POKEMON] twisted the dimensions!",
        ["end"] = "  The twisted dimensions returned to normal!"
    },
    watersport = {start = "  Fire's power was weakened!", ["end"] = "  The effects of Water Sport have faded."},
    wonderroom = {
