...
____exports.MovesText = {
    ...
    absorb = {
        ...
        gen3 = {desc = "The user recovers 1/2 the HP lost by the target, rounded down."},
        gen2 = {
    ...
    accelerock = {name = "Accelerock", desc = "No additional effect.", shortDesc = "Usually goes first."},
    acid = {
        name = "Acid",
        ...
        gen2 = {shortDesc = "10% chance to lower the target's Defense by 1."}
    },
    acidarmor = {
        name = "Acid Armor",
    ...
    aciddownpour = {name = "Acid Downpour", shortDesc = "Power is equal to the base move's Z-Power."},
    acidspray = {
        name = "Acid Spray",
        desc = "Has a 100% chance to lower the target's Special Defense by 2 stages.",
        shortDesc = "100% chance to lower the target's Sp. Def by 2."
    },
    acrobatics = {name = "Acrobatics", shortDesc = "Power doubles if the user has no held item."},
    acupressure = {
        name = "Acupressure",
    ...
    aerialace = {name = "Aerial Ace", shortDesc = "This move does not check accuracy."},
    aeroblast = {
        name = "Aeroblast",
    ...
    alloutpummeling = {name = "All-Out Pummeling", shortDesc = "Power is equal to the base move's Z-Power."},
    allyswitch = {
        name = "Ally Switch",
    ...
    amnesia = {
        ...
        gen1 = {desc = "Raises the user's Special by 2 stages.", shortDesc = "Raises the user's Special by 2."}
    },
    anchorshot = {
        name = "Anchor Shot",
    ...
    aquajet = {name = "Aqua Jet", desc = "No additional effect.", shortDesc = "Usually goes first."},
    aquaring = {
        name = "Aqua Ring",
    ...
    aquatail = {name = "Aqua Tail", shortDesc = "No additional effect."},
    armthrust = {
        name = "Arm Thrust",
    ...
    aromatherapy = {
        ...
        gen5 = {desc = "Every Pokemon in the user's party is cured of its non-volatile status condition."},
    ...
    assurance = {
        ...
        gen4 = {desc = "Power doubles if the target has already taken damage this turn."}
    },
    astonish = {
        name = "Astonish",
        desc = "Has a 30% chance to make the target flinch.",
    ...
    aurasphere = {name = "Aura Sphere", shortDesc = "This move does not check accuracy."},
    aurawheel = {
        name = "Aura Wheel",
    ...
    avalanche = {
        ...
        gen4 = {desc = "Power doubles if the user was hit by a Pokemon in the target's position this turn."}
    },
    babydolleyes = {
        name = "Baby-Doll Eyes",
    ...
    behemothbash = {name = "Behemoth Bash", shortDesc = "Damage doubles if the target is Dynamaxed."},
    behemothblade = {name = "Behemoth Blade", shortDesc = "Damage doubles if the target is Dynamaxed."},
    belch = {
        name = "Belch",
    ...
    blackholeeclipse = {name = "Black Hole Eclipse", shortDesc = "Power is equal to the base move's Z-Power."},
    blastburn = {
        name = "Blast Burn",
    ...
    blizzard = {
        ...
        gen3 = {desc = "Has a 10% chance to freeze the target.", shortDesc = "10% chance to freeze foe(s)."},
        gen2 = {shortDesc = "10% chance to freeze the target."}
    },
    block = {
        name = "Block",
        desc = "Prevents the target from switching out. The target can still switch out if it is holding Shed Shell or uses Baton Pass, Flip Turn, Parting Shot, Teleport, U-turn, or Volt Switch. If the target leaves the field using Baton Pass, the replacement will remain trapped. The effect ends if the user leaves the field.",
    ...
    bloomdoom = {name = "Bloom Doom", shortDesc = "Power is equal to the base move's Z-Power."},
    blueflare = {
        name = "Blue Flare",
    ...
    bodyslam = {
        ...
        gen5 = {desc = "Has a 30% chance to paralyze the target."}
    },
    boltbeak = {
        name = "Bolt Beak",
    ...
    bonemerang = {
        ...
        gen1 = {desc = "Hits twice. If the first hit breaks the target's substitute, the move ends."}
    },
    bonerush = {
        name = "Bone Rush",
        desc = "Hits two to five times. Has a 35% chance to hit two or three times and a 15% chance to hit four or five times. If one of the hits breaks the target's substitute, it will take damage for the remaining hits. If the user has the Skill Link Ability, this move will always hit five times.",
    ...
    branchpoke = {name = "Branch Poke", desc = "No additional effect.", shortDesc = "No additional effect."},
    bravebird = {
        name = "Brave Bird",
    ...
    breakneckblitz = {name = "Breakneck Blitz", shortDesc = "Power is equal to the base move's Z-Power."},
    brickbreak = {
        name = "Brick Break",
    ...
    bubble = {
        ...
        gen2 = {shortDesc = "10% chance to lower the target's Speed by 1."}
    },
    bubblebeam = {
        name = "Bubble Beam",
        desc = "Has a 10% chance to lower the target's Speed by 1 stage.",
    ...
    bulletpunch = {name = "Bullet Punch", desc = "No additional effect.", shortDesc = "Usually goes first."},
    bulletseed = {
        name = "Bullet Seed",
        desc = "Hits two to five times. Has a 35% chance to hit two or three times and a 15% chance to hit four or five times. If one of the hits breaks the target's substitute, it will take damage for the remaining hits. If the user has the Skill Link Ability, this move will always hit five times.",
        shortDesc = "Hits 2-5 times in one turn.",
    ...
    catastropika = {name = "Catastropika", shortDesc = "No additional effect."},
    celebrate = {name = "Celebrate", shortDesc = "No competitive use.", activate = "  Congratulations, [TRAINER]!"},
    charge = {
        name = "Charge",
    ...
    clearsmog = {name = "Clear Smog", shortDesc = "Resets all of the target's stat stages to 0."},
    closecombat = {
        name = "Close Combat",
    ...
    continentalcrush = {name = "Continental Crush", shortDesc = "Power is equal to the base move's Z-Power."},
    conversion = {
        name = "Conversion",
    ...
    corkscrewcrash = {name = "Corkscrew Crash", shortDesc = "Power is equal to the base move's Z-Power."},
    corrosivegas = {
        name = "Corrosive Gas",
    ...
    crushgrip = {
        ...
        gen4 = {desc = "Power is equal to 120 * (target's current HP / target's maximum HP) + 1, rounded down."}
    },
    curse = {
        name = "Curse",
    ...
    cut = {name = "Cut", shortDesc = "No additional effect."},
    darkestlariat = {
        name = "Darkest Lariat",
        desc = "Ignores the target's stat stage changes, including evasiveness.",
        shortDesc = "Ignores the target's stat stage changes."
    ...
    darkvoid = {
        ...
        gen6 = {desc = "Causes the target to fall asleep.", shortDesc = "Causes the foe(s) to fall asleep."},
    ...
    defensecurl = {
        ...
        gen1 = {desc = "Raises the user's Defense by 1 stage."}
    },
    defog = {
        name = "Defog",
    ...
    devastatingdrake = {name = "Devastating Drake", shortDesc = "Power is equal to the base move's Z-Power."},
    diamondstorm = {
        name = "Diamond Storm",
    ...
    dizzypunch = {
        ...
        gen1 = {desc = "No additional effect.", shortDesc = "No additional effect."}
    },
    doomdesire = {
        name = "Doom Desire",
    ...
    dragonclaw = {name = "Dragon Claw", shortDesc = "No additional effect."},
    dragondance = {
        name = "Dragon Dance",
    ...
    dragonhammer = {name = "Dragon Hammer", shortDesc = "No additional effect."},
    dragonpulse = {name = "Dragon Pulse", shortDesc = "No additional effect."},
    dragonrage = {name = "Dragon Rage", shortDesc = "Deals 40 HP of damage to the target."},
    dragonrush = {
        name = "Dragon Rush",
        ...
        shortDesc = "20% chance to make the target flinch.",
        gen5 = {desc = "Has a 20% chance to make the target flinch."}
    },
    dragontail = {
        name = "Dragon Tail",
    ...
    drillpeck = {name = "Drill Peck", shortDesc = "No additional effect."},
    drillrun = {
        name = "Drill Run",
        desc = "Has a higher chance for a critical hit.",
        shortDesc = "High critical hit ratio."
    ...
    dynamaxcannon = {name = "Dynamax Cannon", shortDesc = "Damage doubles if the target is Dynamaxed."},
    dynamicpunch = {
        name = "Dynamic Punch",
        desc = "Has a 100% chance to confuse the target.",
        shortDesc = "100% chance to confuse the target."
    ...
    earthquake = {
        ...
        gen1 = {desc = "No additional effect.", shortDesc = "No additional effect."},
        gen2 = {shortDesc = "Power doubles on Dig."}
    },
    echoedvoice = {
        name = "Echoed Voice",
    ...
    eggbomb = {name = "Egg Bomb", shortDesc = "No additional effect."},
    electricterrain = {
    ...
    extremespeed = {
        ...
        gen4 = {shortDesc = "Usually goes first."}
    },
    facade = {
        name = "Facade",
        ...
        gen5 = {desc = "Power doubles if the user is burned, paralyzed, or poisoned."}
    },
    fairylock = {
        name = "Fairy Lock",
    ...
    fairywind = {name = "Fairy Wind", shortDesc = "No additional effect."},
    fakeout = {
        name = "Fake Out",
    ...
    falsesurrender = {name = "False Surrender", shortDesc = "This move does not check accuracy."},
    falseswipe = {
        name = "False Swipe",
    ...
    feintattack = {name = "Feint Attack", shortDesc = "This move does not check accuracy."},
    fellstinger = {
        name = "Fell Stinger",
    ...
    fireblast = {
        ...
        desc = "Has a 10% chance to burn the target.",
        shortDesc = "10% chance to burn the target.",
        gen1 = {desc = "Has a 30% chance to burn the target.", shortDesc = "30% chance to burn the target."}
    },
    firefang = {
        name = "Fire Fang",
    ...
    gigavolthavoc = {name = "Gigavolt Havoc", shortDesc = "Power is equal to the base move's Z-Power."},
    glaciallance = {
        name = "Glacial Lance",
        desc = "No additional effect.",
        shortDesc = "No additional effect. Hits adjacent foes."
    ...
    glare = {
        ...
        gen3 = {desc = "Paralyzes the target. This move does not ignore type immunity."},
        gen1 = {desc = "Paralyzes the target."}
    },
    glitzyglow = {
        name = "Glitzy Glow",
    ...
    grasswhistle = {name = "Grass Whistle", shortDesc = "Causes the target to fall asleep."},
    grassyglide = {
        name = "Grassy Glide",
    ...
    growl = {
        ...
        gen2 = {shortDesc = "Lowers the target's Attack by 1."}
    },
    growth = {
        name = "Growth",
        ...
        gen4 = {desc = "Raises the user's Special Attack by 1 stage.", shortDesc = "Raises the user's Sp. Atk by 1."},
        gen1 = {desc = "Raises the user's Special by 1 stage.", shortDesc = "Raises the user's Special by 1."}
    },
    grudge = {
        name = "Grudge",
    ...
    gust = {
        ...
        gen2 = {desc = "Power doubles if the target is using Fly.", shortDesc = "Power doubles during Fly."},
        gen1 = {desc = "No additional effect.", shortDesc = "No additional effect."}
    },
    gyroball = {
        name = "Gyro Ball",
    ...
    healbell = {
        ...
        gen2 = {desc = "Every Pokemon in the user's party is cured of its non-volatile status condition."},
    ...
    healorder = {
        ...
        gen4 = {desc = "The user restores 1/2 of its maximum HP, rounded down."}
    },
    healpulse = {
        name = "Heal Pulse",
        ...
        shortDesc = "Heals the target by 50% of its max HP.",
        gen5 = {desc = "The target restores 1/2 of its maximum HP, rounded half up."}
    },
    heartstamp = {
        name = "Heart Stamp",
        desc = "Has a 30% chance to make the target flinch.",
    ...
    hiddenpowerdark = {name = "Hidden Power Dark"},
    hiddenpowerdragon = {name = "Hidden Power Dragon"},
    hiddenpowerelectric = {name = "Hidden Power Electric"},
    hiddenpowerfighting = {name = "Hidden Power Fighting"},
    hiddenpowerfire = {name = "Hidden Power Fire"},
    hiddenpowerflying = {name = "Hidden Power Flying"},
    hiddenpowerghost = {name = "Hidden Power Ghost"},
    hiddenpowergrass = {name = "Hidden Power Grass"},
    hiddenpowerground = {name = "Hidden Power Ground"},
    hiddenpowerice = {name = "Hidden Power Ice"},
    hiddenpowerpoison = {name = "Hidden Power Poison"},
    hiddenpowerpsychic = {name = "Hidden Power Psychic"},
    hiddenpowerrock = {name = "Hidden Power Rock"},
    hiddenpowersteel = {name = "Hidden Power Steel"},
    hiddenpowerwater = {name = "Hidden Power Water"},
    highhorsepower = {name = "High Horsepower", shortDesc = "No additional effect."},
    highjumpkick = {
        name = "High Jump Kick",
    ...
    hornattack = {name = "Horn Attack", shortDesc = "No additional effect."},
    horndrill = {
        name = "Horn Drill",
        desc = "Deals damage to the target equal to the target's maximum HP. Ignores accuracy and evasiveness modifiers. This attack's accuracy is equal to (user's level - target's level + 30)%, and fails if the target is at a higher level. Pokemon with the Sturdy Ability are immune.",
        shortDesc = "OHKOs the target. Fails if user is a lower level.",
    ...
    howl = {
        ...
        gen7 = {desc = "Raises the user's Attack by 1 stage.", shortDesc = "Raises the user's Attack by 1."}
    },
    hurricane = {
        name = "Hurricane",
    ...
    hydropump = {name = "Hydro Pump", shortDesc = "No additional effect."},
    hydrovortex = {name = "Hydro Vortex", shortDesc = "Power is equal to the base move's Z-Power."},
    hyperbeam = {
        name = "Hyper Beam",
        desc = "If this move is successful, the user must recharge on the following turn and cannot select a move.",
        shortDesc = "User cannot move next turn.",
    ...
    hypnosis = {name = "Hypnosis", shortDesc = "Causes the target to fall asleep."},
    iceball = {
        name = "Ice Ball",
    ...
    iceshard = {name = "Ice Shard", desc = "No additional effect.", shortDesc = "Usually goes first."},
    iciclecrash = {
        name = "Icicle Crash",
        desc = "Has a 30% chance to make the target flinch.",
        shortDesc = "30% chance to make the target flinch."
    ...
    icywind = {
        ...
        desc = "Has a 100% chance to lower the target's Speed by 1 stage.",
        shortDesc = "100% chance to lower the foe(s) Speed by 1.",
        gen2 = {shortDesc = "100% chance to lower the target's Speed by 1."}
    },
    imprison = {
        name = "Imprison",
    ...
    infernooverdrive = {name = "Inferno Overdrive", shortDesc = "Power is equal to the base move's Z-Power."},
    infestation = {
        name = "Infestation",
        desc = "Prevents the target from switching for four or five turns (seven turns if the user is holding Grip Claw). Causes damage to the target equal to 1/8 of its maximum HP (1/6 if the user is holding Binding Band), rounded down, at the end of each turn during effect. The target can still switch out if it is holding Shed Shell or uses Baton Pass, Flip Turn, Parting Shot, Teleport, U-turn, or Volt Switch. The effect ends if either the user or the target leaves the field, or if the target uses Rapid Spin or Substitute successfully. This effect is not stackable or reset by using this or another binding move.",
        shortDesc = "Traps and damages the target for 4-5 turns.",
    ...
    leafage = {name = "Leafage", shortDesc = "No additional effect."},
    leafblade = {
        name = "Leaf Blade",
        desc = "Has a higher chance for a critical hit.",
        shortDesc = "High critical hit ratio."
    ...
    leer = {
        ...
        gen2 = {shortDesc = "Lowers the target's Defense by 1."}
    },
    letssnuggleforever = {name = "Let's Snuggle Forever", shortDesc = "No additional effect."},
    lick = {
        name = "Lick",
        desc = "Has a 30% chance to paralyze the target.",
        shortDesc = "30% chance to paralyze the target."
    ...
    lovelykiss = {name = "Lovely Kiss", shortDesc = "Causes the target to fall asleep."},
    lowkick = {
        name = "Low Kick",
        desc = "This move's power is 20 if the target weighs less than 10 kg, 40 if less than 25 kg, 60 if less than 50 kg, 80 if less than 100 kg, 100 if less than 200 kg, and 120 if greater than or equal to 200 kg.",
        shortDesc = "More power the heavier the target.",
    ...
    machpunch = {name = "Mach Punch", desc = "No additional effect.", shortDesc = "Usually goes first."},
    magicalleaf = {name = "Magical Leaf", shortDesc = "This move does not check accuracy."},
    magiccoat = {
        name = "Magic Coat",
    ...
    magnetbomb = {name = "Magnet Bomb", shortDesc = "This move does not check accuracy."},
    magneticflux = {
        name = "Magnetic Flux",
    ...
    megahorn = {name = "Megahorn", shortDesc = "No additional effect."},
    megakick = {name = "Mega Kick", shortDesc = "No additional effect."},
    megapunch = {name = "Mega Punch", shortDesc = "No additional effect."},
    memento = {
        name = "Memento",
    ...
    metronome = {
        ...
        gen1 = {desc = "A random move is selected for use, other than Metronome or Struggle."},
    ...
    minimize = {
        ...
        gen1 = {desc = "Raises the user's evasiveness by 1 stage."}
    },
    miracleeye = {
        name = "Miracle Eye",
    ...
    neverendingnightmare = {name = "Never-Ending Nightmare", shortDesc = "Power is equal to the base move's Z-Power."},
    nightdaze = {
        name = "Night Daze",
    ...
    oceanicoperetta = {name = "Oceanic Operetta", shortDesc = "No additional effect."},
    octazooka = {
        name = "Octazooka",
        desc = "Has a 50% chance to lower the target's accuracy by 1 stage.",
        shortDesc = "50% chance to lower the target's accuracy by 1."
    ...
    overdrive = {name = "Overdrive", desc = "No additional effect.", shortDesc = "No additional effect. Hits foe(s)."},
    overheat = {
        name = "Overheat",
        desc = "Lowers the user's Special Attack by 2 stages.",
        shortDesc = "Lowers the user's Sp. Atk by 2."
    ...
    payback = {
        ...
        gen4 = {desc = "Power doubles if the user moves after the target this turn. Switching in counts as an action."}
    },
    payday = {
        name = "Pay Day",
        desc = "No additional effect.",
    ...
    peck = {name = "Peck", shortDesc = "No additional effect."},
    perishsong = {
        name = "Perish Song",
    ...
    poisongas = {
        ...
        gen2 = {shortDesc = "Poisons the target."}
    },
    poisonjab = {
        name = "Poison Jab",
        desc = "Has a 30% chance to poison the target.",
    ...
    poisonpowder = {name = "Poison Powder", desc = "Poisons the target.", shortDesc = "Poisons the target."},
    poisonsting = {
        name = "Poison Sting",
        desc = "Has a 30% chance to poison the target.",
        shortDesc = "30% chance to poison the target.",
        gen1 = {desc = "Has a 20% chance to poison the target.", shortDesc = "20% chance to poison the target."}
    },
    poisontail = {
        name = "Poison Tail",
        desc = "Has a 10% chance to poison the target and a higher chance for a critical hit.",
    ...
    pound = {name = "Pound", shortDesc = "No additional effect."},
    powder = {
        name = "Powder",
    ...
    powergem = {name = "Power Gem", shortDesc = "No additional effect."},
    powersplit = {
        name = "Power Split",
    ...
    powerwhip = {name = "Power Whip", shortDesc = "No additional effect."},
    precipiceblades = {
    ...
    pulverizingpancake = {name = "Pulverizing Pancake", shortDesc = "No additional effect."},
    punishment = {
        name = "Punishment",
    ...
    quickattack = {name = "Quick Attack", desc = "No additional effect.", shortDesc = "Usually goes first."},
    quickguard = {
        name = "Quick Guard",
    ...
    razorleaf = {
        ...
        desc = "Has a higher chance for a critical hit.",
        shortDesc = "High critical hit ratio. Hits adjacent foes.",
        gen2 = {shortDesc = "High critical hit ratio."}
    },
    razorshell = {
        name = "Razor Shell",
        desc = "Has a 50% chance to lower the target's Defense by 1 stage.",
    ...
    revenge = {
        ...
        desc = "Power doubles if the user was hit by the target this turn.",
        shortDesc = "Power doubles if user is damaged by the target.",
        gen4 = {desc = "Power doubles if the user was hit by a Pokemon in the target's current position this turn."},
        gen3 = {
    ...
    roar = {
        ...
        gen1 = {desc = "No competitive use.", shortDesc = "No competitive use."}
    },
    roaroftime = {
        name = "Roar of Time",
        desc = "If this move is successful, the user must recharge on the following turn and cannot select a move.",
    ...
    rockslide = {
        ...
        gen1 = {desc = "No additional effect.", shortDesc = "No additional effect."},
        gen2 = {shortDesc = "30% chance to make the target flinch."}
    },
    rocksmash = {
        name = "Rock Smash",
        desc = "Has a 50% chance to lower the target's Defense by 1 stage.",
    ...
    rockthrow = {name = "Rock Throw", shortDesc = "No additional effect."},
    rocktomb = {
        name = "Rock Tomb",
        desc = "Has a 100% chance to lower the target's Speed by 1 stage.",
        shortDesc = "100% chance to lower the target's Speed by 1."
    ...
    savagespinout = {name = "Savage Spin-Out", shortDesc = "Power is equal to the base move's Z-Power."},
    scald = {
        name = "Scald",
        desc = "Has a 30% chance to burn the target. The target thaws out if it is frozen.",
        shortDesc = "30% chance to burn the target. Thaws target.",
        gen5 = {desc = "Has a 30% chance to burn the target.", shortDesc = "30% chance to burn the target."}
    },
    scaleshot = {
        name = "Scale Shot",
    ...
    scratch = {name = "Scratch", shortDesc = "No additional effect."},
    screech = {
        name = "Screech",
    ...
    seedbomb = {name = "Seed Bomb", shortDesc = "No additional effect."},
    seedflare = {
        name = "Seed Flare",
    ...
    shadowpunch = {name = "Shadow Punch", shortDesc = "This move does not check accuracy."},
    shadowsneak = {name = "Shadow Sneak", desc = "No additional effect.", shortDesc = "Usually goes first."},
    shadowstrike = {
        name = "Shadow Strike",
        desc = "Has a 50% chance to lower the target's Defense by 1 stage.",
        shortDesc = "50% chance to lower the target's Defense by 1."
    ...
    shatteredpsyche = {name = "Shattered Psyche", shortDesc = "Power is equal to the base move's Z-Power."},
    sheercold = {
        name = "Sheer Cold",
    ...
    shockwave = {name = "Shock Wave", shortDesc = "This move does not check accuracy."},
    shoreup = {
        name = "Shore Up",
    ...
    sing = {name = "Sing", shortDesc = "Causes the target to fall asleep."},
    sinisterarrowraid = {name = "Sinister Arrow Raid", shortDesc = "No additional effect."},
    sizzlyslide = {
        name = "Sizzly Slide",
    ...
    sketch = {
        ...
        gen2 = {desc = "Fails when used in Link Battles.", shortDesc = "Fails when used in Link Battles."},
    ...
    slam = {name = "Slam", shortDesc = "No additional effect."},
    slash = {name = "Slash", desc = "Has a higher chance for a critical hit.", shortDesc = "High critical hit ratio."},
    sleeppowder = {name = "Sleep Powder", shortDesc = "Causes the target to fall asleep."},
    sleeptalk = {
        name = "Sleep Talk",
    ...
    sludge = {
        ...
        desc = "Has a 30% chance to poison the target.",
        shortDesc = "30% chance to poison the target.",
        gen1 = {desc = "Has a 40% chance to poison the target.", shortDesc = "40% chance to poison the target."}
    },
    sludgebomb = {
        name = "Sludge Bomb",
        desc = "Has a 30% chance to poison the target.",
    ...
    smartstrike = {name = "Smart Strike", shortDesc = "This move does not check accuracy."},
    smellingsalts = {
        name = "Smelling Salts",
    ...
    soak = {
        ...
        gen5 = {desc = "Causes the target to become a Water type. Fails if the target is an Arceus."}
    },
    softboiled = {
        name = "Soft-Boiled",
        desc = "The user restores 1/2 of its maximum HP, rounded half up.",
    ...
    sonicboom = {
        ...
        gen1 = {desc = "Deals 20 HP of damage to the target. This move ignores type immunity."}
    },
    soulstealing7starstrike = {name = "Soul-Stealing 7-Star Strike", shortDesc = "No additional effect."},
    spacialrend = {
        name = "Spacial Rend",
        desc = "Has a higher chance for a critical hit.",
        shortDesc = "High critical hit ratio."
    ...
    splash = {name = "Splash", shortDesc = "No competitive use.", activate = "  But nothing happened!"},
    ...
    spore = {name = "Spore", shortDesc = "Causes the target to fall asleep."},
    spotlight = {
        name = "Spotlight",
    ...
    stomp = {
        ...
        gen1 = {desc = "Has a 30% chance to make the target flinch."}
    },
    stompingtantrum = {
    ...
    strength = {name = "Strength", shortDesc = "No additional effect."},
    strengthsap = {
        name = "Strength Sap",
    ...
    stringshot = {
        ...
        gen5 = {desc = "Lowers the target's Speed by 1 stage.", shortDesc = "Lowers the foe(s) Speed by 1."},
        gen2 = {shortDesc = "Lowers the target's Speed by 1."}
    },
    struggle = {
        name = "Struggle",
    ...
    subzeroslammer = {name = "Subzero Slammer", shortDesc = "Power is equal to the base move's Z-Power."},
    suckerpunch = {
        name = "Sucker Punch",
    ...
    supersonic = {name = "Supersonic", shortDesc = "Causes the target to become confused."},
    supersonicskystrike = {name = "Supersonic Skystrike", shortDesc = "Power is equal to the base move's Z-Power."},
    surf = {
        name = "Surf",
        ...
        gen2 = {desc = "No additional effect.", shortDesc = "No additional effect."},
        gen3 = {shortDesc = "Hits foes. Power doubles against Dive."}
    },
    surgingstrikes = {
    ...
    sweetkiss = {name = "Sweet Kiss", shortDesc = "Causes the target to become confused."},
    sweetscent = {
        name = "Sweet Scent",
        desc = "Lowers the target's evasiveness by 2 stages.",
        shortDesc = "Lowers the foe(s) evasiveness by 2.",
        gen5 = {desc = "Lowers the target's evasiveness by 1 stage.", shortDesc = "Lowers the foe(s) evasiveness by 1."},
        gen2 = {shortDesc = "Lowers the target's evasiveness by 1."}
    },
    swift = {
        name = "Swift",
        desc = "This move does not check accuracy.",
        ...
        gen2 = {shortDesc = "This move does not check accuracy."}
    },
    switcheroo = {
        name = "Switcheroo",
    ...
    tackle = {name = "Tackle", shortDesc = "No additional effect."},
    tailglow = {
        name = "Tail Glow",
        desc = "Raises the user's Special Attack by 3 stages.",
        shortDesc = "Raises the user's Sp. Atk by 3.",
        gen4 = {desc = "Raises the user's Special Attack by 2 stages.", shortDesc = "Raises the user's Sp. Atk by 2."}
    },
    tailslap = {
        name = "Tail Slap",
        desc = "Hits two to five times. Has a 35% chance to hit two or three times and a 15% chance to hit four or five times. If one of the hits breaks the target's substitute, it will take damage for the remaining hits. If the user has the Skill Link Ability, this move will always hit five times.",
    ...
    taunt = {
        ...
        gen5 = {desc = "Prevents the target from using non-damaging moves for its next three turns."},
        gen4 = {
    ...
    tectonicrage = {name = "Tectonic Rage", shortDesc = "Power is equal to the base move's Z-Power."},
    teeterdance = {
        name = "Teeter Dance",
        desc = "Causes the target to become confused.",
    ...
    teleport = {
        ...
        gen7 = {desc = "Fails when used.", shortDesc = "Fails when used."}
    },
    terrainpulse = {
        name = "Terrain Pulse",
    ...
    thunder = {
        ...
        gen1 = {desc = "Has a 10% chance to paralyze the target.", shortDesc = "10% chance to paralyze the target."}
    },
    thunderbolt = {
        name = "Thunderbolt",
    ...
    toxic = {
        ...
        gen5 = {desc = "Badly poisons the target.", shortDesc = "Badly poisons the target."}
    },
    toxicspikes = {
        name = "Toxic Spikes",
    ...
    twinkletackle = {name = "Twinkle Tackle", shortDesc = "Power is equal to the base move's Z-Power."},
    twister = {
        name = "Twister",
    ...
    vacuumwave = {name = "Vacuum Wave", desc = "No additional effect.", shortDesc = "Usually goes first."},
    vcreate = {
        name = "V-create",
    ...
    vinewhip = {name = "Vine Whip", shortDesc = "No additional effect."},
    visegrip = {name = "Vise Grip", shortDesc = "No additional effect."},
    vitalthrow = {
        name = "Vital Throw",
        desc = "This move does not check accuracy.",
    ...
    wakeupslap = {
        ...
        gen4 = {desc = "Power doubles if the target is asleep. If this move is successful, the target wakes up."}
    },
    waterfall = {
        name = "Waterfall",
        desc = "Has a 20% chance to make the target flinch.",
        shortDesc = "20% chance to make the target flinch.",
        gen3 = {desc = "No additional effect.", shortDesc = "No additional effect."}
    },
    watergun = {name = "Water Gun", shortDesc = "No additional effect."},
    waterpledge = {
        name = "Water Pledge",
    ...
    willowisp = {name = "Will-O-Wisp", desc = "Burns the target.", shortDesc = "Burns the target."},
    wingattack = {name = "Wing Attack", shortDesc = "No additional effect."},
    wish = {
        name = "Wish",
    ...
    xscissor = {name = "X-Scissor", shortDesc = "No additional effect."},
    yawn = {
        name = "Yawn",
    ...
    zippyzap = {
        ...
        gen7 = {desc = "Will always result in a critical hit.", shortDesc = "Nearly always goes first. Always crits."}
    }
}
