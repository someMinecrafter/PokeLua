...
____exports.AbilitiesText = {
    ...
    asoneglastrier = {name = "As One (Glastrier)", shortDesc = "The combination of Unnerve and Chilling Neigh."},
    asonespectrier = {name = "As One (Spectrier)", shortDesc = "The combination of Unnerve and Grim Neigh."},
    aurabreak = {
        name = "Aura Break",
    ...
    ballfetch = {name = "Ball Fetch", shortDesc = "No competitive use."},
    battery = {
        name = "Battery",
        shortDesc = "This Pokemon's allies have the power of their special attacks multiplied by 1.3."
    },
    battlearmor = {name = "Battle Armor", shortDesc = "This Pokemon cannot be struck by a critical hit."},
    battlebond = {
        name = "Battle Bond",
    ...
    chlorophyll = {
        ...
        gen7 = {desc = "If Sunny Day is active, this Pokemon's Speed is doubled."}
    },
    clearbody = {name = "Clear Body", shortDesc = "Prevents other Pokemon from lowering this Pokemon's stat stages."},
    cloudnine = {
        name = "Cloud Nine",
        shortDesc = "While this Pokemon is active, the effects of weather conditions are disabled.",
        start = "#airlock"
    ...
    compoundeyes = {name = "Compound Eyes", shortDesc = "This Pokemon's moves have their accuracy multiplied by 1.3."},
    contrary = {
        name = "Contrary",
        ...
        gen6 = {desc = "If this Pokemon has a stat stage raised it is lowered instead, and vice versa."}
    },
    corrosion = {
        name = "Corrosion",
    ...
    drizzle = {name = "Drizzle", shortDesc = "On switch-in, this Pokemon summons Rain Dance."},
    drought = {name = "Drought", shortDesc = "On switch-in, this Pokemon summons Sunny Day."},
    dryskin = {
        name = "Dry Skin",
    ...
    earlybird = {name = "Early Bird", shortDesc = "This Pokemon's sleep counter drops by 2 instead of 1."},
    effectspore = {
        name = "Effect Spore",
    ...
    electricsurge = {name = "Electric Surge", shortDesc = "On switch-in, this Pokemon summons Electric Terrain."},
    emergencyexit = {
        name = "Emergency Exit",
    ...
    filter = {name = "Filter", shortDesc = "This Pokemon receives 3/4 damage from supereffective attacks."},
    flamebody = {
        name = "Flame Body",
    ...
    frisk = {
        ...
        gen5 = {shortDesc = "On switch-in, this Pokemon identifies a random foe's held item."},
    ...
    furcoat = {name = "Fur Coat", shortDesc = "This Pokemon's Defense is doubled."},
    galewings = {
        name = "Gale Wings",
        shortDesc = "If this Pokemon is at full HP, its Flying-type moves have their priority increased by 1.",
        gen6 = {shortDesc = "This Pokemon's Flying-type moves have their priority increased by 1."}
    },
    galvanize = {
        name = "Galvanize",
    ...
    grassysurge = {name = "Grassy Surge", shortDesc = "On switch-in, this Pokemon summons Grassy Terrain."},
    grimneigh = {
        name = "Grim Neigh",
    ...
    heavymetal = {name = "Heavy Metal", shortDesc = "This Pokemon's weight is doubled."},
    honeygather = {name = "Honey Gather", shortDesc = "No competitive use."},
    hugepower = {name = "Huge Power", shortDesc = "This Pokemon's Attack is doubled."},
    hungerswitch = {
        name = "Hunger Switch",
    ...
    icescales = {name = "Ice Scales", shortDesc = "This Pokemon receives 1/2 damage from special attacks."},
    illuminate = {name = "Illuminate", shortDesc = "No competitive use."},
    illusion = {
        name = "Illusion",
    ...
    innerfocus = {
        ...
        gen7 = {shortDesc = "This Pokemon cannot be made to flinch."}
    },
    insomnia = {
        name = "Insomnia",
    ...
    intrepidsword = {name = "Intrepid Sword", shortDesc = "On switch-in, this Pokemon's Attack is raised by 1 stage."},
    ironbarbs = {
        name = "Iron Barbs",
    ...
    lightmetal = {name = "Light Metal", shortDesc = "This Pokemon's weight is halved."},
    lightningrod = {
        name = "Lightning Rod",
    ...
    longreach = {name = "Long Reach", shortDesc = "This Pokemon's attacks do not make contact with the target."},
    magicbounce = {
        name = "Magic Bounce",
    ...
    merciless = {name = "Merciless", shortDesc = "This Pokemon's attacks are critical hits if the target is poisoned."},
    mimicry = {
        name = "Mimicry",
    ...
    mistysurge = {name = "Misty Surge", shortDesc = "On switch-in, this Pokemon summons Misty Terrain."},
    moldbreaker = {
        name = "Mold Breaker",
    ...
    multitype = {
        ...
        gen6 = {shortDesc = "If this Pokemon is an Arceus, its type changes to match its held Plate."}
    },
    mummy = {
        name = "Mummy",
    ...
    noguard = {name = "No Guard", shortDesc = "Every move used by or against this Pokemon will always hit."},
    normalize = {
        name = "Normalize",
    ...
    overcoat = {
        ...
        gen5 = {shortDesc = "This Pokemon is immune to damage from Sandstorm or Hail."}
    },
    overgrow = {
        name = "Overgrow",
    ...
    pickup = {
        ...
        gen4 = {desc = "No competitive use.", shortDesc = "No competitive use."},
        addItem = "#recycle"
    },
    pixilate = {
        name = "Pixilate",
    ...
    poisontouch = {name = "Poison Touch", shortDesc = "This Pokemon's contact moves have a 30% chance of poisoning."},
    powerconstruct = {
    ...
    prankster = {
        ...
        gen6 = {shortDesc = "This Pokemon's non-damaging moves have their priority increased by 1."}
    },
    pressure = {
        name = "Pressure",
    ...
    psychicsurge = {name = "Psychic Surge", shortDesc = "On switch-in, this Pokemon summons Psychic Terrain."},
    punkrock = {
        name = "Punk Rock",
    ...
    purepower = {name = "Pure Power", shortDesc = "This Pokemon's Attack is doubled."},
    queenlymajesty = {
    ...
    ripen = {name = "Ripen", shortDesc = "When this Pokemon eats a Berry, its effect is doubled."},
    rivalry = {
        name = "Rivalry",
    ...
    sandstream = {name = "Sand Stream", shortDesc = "On switch-in, this Pokemon summons Sandstorm."},
    sandveil = {
        name = "Sand Veil",
    ...
    shellarmor = {name = "Shell Armor", shortDesc = "This Pokemon cannot be struck by a critical hit."},
    shielddust = {
        name = "Shield Dust",
    ...
    simple = {
        ...
        gen6 = {desc = "When this Pokemon's stat stages are raised or lowered, the effect is doubled instead."},
        gen4 = {shortDesc = "This Pokemon's stat stages are considered doubled during stat calculations."}
    },
    skilllink = {
        name = "Skill Link",
    ...
    slushrush = {name = "Slush Rush", shortDesc = "If Hail is active, this Pokemon's Speed is doubled."},
    sniper = {
        name = "Sniper",
    ...
    snowwarning = {name = "Snow Warning", shortDesc = "On switch-in, this Pokemon summons Hail."},
    solarpower = {
        name = "Solar Power",
    ...
    solidrock = {name = "Solid Rock", shortDesc = "This Pokemon receives 3/4 damage from supereffective attacks."},
    soulheart = {
        name = "Soul-Heart",
    ...
    soundproof = {
        ...
        gen5 = {shortDesc = "This Pokemon is immune to sound-based moves, except Heal Bell."},
        gen4 = {shortDesc = "This Pokemon is immune to sound-based moves, including Heal Bell."}
    },
    speedboost = {
        name = "Speed Boost",
    ...
    steadfast = {name = "Steadfast", shortDesc = "If this Pokemon flinches, its Speed is raised by 1 stage."},
    steamengine = {
        name = "Steam Engine",
    ...
    superluck = {name = "Super Luck", shortDesc = "This Pokemon's critical hit ratio is raised by 1 stage."},
    surgesurfer = {name = "Surge Surfer", shortDesc = "If Electric Terrain is active, this Pokemon's Speed is doubled."},
    swarm = {
        name = "Swarm",
    ...
    swiftswim = {
        ...
        gen7 = {desc = "If Rain Dance is active, this Pokemon's Speed is doubled."}
    },
    symbiosis = {
        name = "Symbiosis",
    ...
    thickfat = {
        ...
        gen4 = {shortDesc = "The power of Fire- and Ice-type attacks against this Pokemon is halved."}
    },
    tintedlens = {
        name = "Tinted Lens",
    ...
    toughclaws = {name = "Tough Claws", shortDesc = "This Pokemon's contact moves have their power multiplied by 1.3."},
    toxicboost = {
        name = "Toxic Boost",
    ...
    triage = {name = "Triage", shortDesc = "This Pokemon's healing moves have their priority increased by 3."},
    truant = {
        name = "Truant",
    ...
    whitesmoke = {name = "White Smoke", shortDesc = "Prevents other Pokemon from lowering this Pokemon's stat stages."},
    wimpout = {
        name = "Wimp Out",
        desc = "When this Pokemon has more than 1/2 its maximum HP and takes damage bringing it to 1/2 or less of its maximum HP, it immediately switches out to a chosen ally. This effect applies after all hits from a multi-hit move; Sheer Force prevents it from activating if the move has a secondary effect. This effect applies to both direct and indirect damage, except Curse and Substitute on use, Belly Drum, Pain Split, and confusion damage.",
        shortDesc = "This Pokemon switches out when it reaches 1/2 or less of its maximum HP."
    ...
    wonderguard = {
        ...
        gen4 = {shortDesc = "This Pokemon is only damaged by Fire Fang, supereffective moves, indirect damage."},
        gen3 = {shortDesc = "This Pokemon is only damaged by supereffective moves and indirect damage."}
    },
    wonderskin = {
        name = "Wonder Skin",
